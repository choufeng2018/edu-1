...
<body>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>会员级别：</label></td>
					<td class="width-35">
						<sys:gridselect url="${ctx}/schoollevel/tCommSchoolLevel/selectlist" id="category" name="tSchoolLevel.id"  value="${tCommSchool.tSchoolLevel.id}"  title="选择会员等级" labelName="tSchoolLevel.levelDesc" 
							labelValue="${tCommSchool.tSchoolLevel.levelDesc}" cssClass="form-control required" fieldLabels="商品分类|备注" fieldKeys="name|remarks" searchLabel="分类名" searchKey="name" ></sys:gridselect>
					</td>
