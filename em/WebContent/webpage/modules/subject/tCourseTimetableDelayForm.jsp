...
<body>
		<form:form id="inputForm" modelAttribute="tCourseTimetable" action="${ctx}/subject/tCourseTimetable/save?opertype=delay&source=${source}" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">${tCourseTimetable.courseclass.classDesc}</td> 
				...
				<tr>
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>后延时长（周）：</label></td>
					<td class="width-35" colspan="3">
						<form:input path="shour" htmlEscape="false" maxlength="100" class="form-control digit"/><br/>
						<label><font color="red">请输入后续课程整体后延时长：以周为基本单位</font></label>
					</td>
				</tr>
				<tr>
