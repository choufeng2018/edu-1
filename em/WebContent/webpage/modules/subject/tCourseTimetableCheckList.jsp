	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		...
		<c:forEach items="${page.list}" var="tCourseTimetable">
			<tr>
				...
				<td>
					<shiro:hasPermission name="teaching:tClassStudent:checklist">
    					<a href="#" onclick="openDialog('考勤', '${ctx}/subject/tCourseTimetable/checkform?id=${tCourseTimetable.id}','900px', '600px')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i> ${tCourseTimetable.status==2?'修改考勤':'考勤'}</a>
    				</shiro:hasPermission>
				</td>
			</tr>
		</c:forEach>
