...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="TCourseTimetable" action="${ctx}/subject/tCourseTimetable/adjustlist" method="post" class="form-inline">
			...
			<tr>
				...
				<td>
					...
					<shiro:hasPermission name="subject:tCourseTimetable:edit">
    					<a href="#" onclick="openDialog('调整上课时间', '${ctx}/subject/tCourseTimetable/timeform?id=${tCourseTimetable.id}&source=adjust','800px', '500px')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i> 调整时间</a>
    				</shiro:hasPermission>
					</c:if>
				</td>
			</tr>
