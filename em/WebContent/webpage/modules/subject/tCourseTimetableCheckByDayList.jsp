...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
            ...
            $("#refrashButton").click(function(){
				window.location = "${ctx}/subject/tCourseTimetable/daychecklist";
			});
		}); 
	</script>
</head>
...
<div class="wrapper wrapper-content">
	...
	<div class="ibox-title">
		...
		<div class="ibox-tools">
			<a class="close-link">
				<i id="refrashButton" class="glyphicon glyphicon-repeat">刷新</i>
			</a>
		</div>
	</div>
                            ...
                            <c:forEach items="${yesterdayList}" var="tCourseTimetable">
                                <li class="${tCourseTimetable.status==1?'warning-element':'success-element'}" id="task1">
                                    ...
                                    <div class="agile-detail">
                                        ...
                                        <a href="javascript:openDialogView('查看考勤', '${ctx}/subject/tCourseTimetable/checkform?id=${tCourseTimetable.id}&source=new','900px', '600px')" class="pull-right btn btn-xs btn-primary">查看考勤</a>
                                        </c:if>
