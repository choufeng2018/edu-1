...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="TClassStudent" action="${ctx}/teaching/tClassStudent/biglist" method="post" class="form-inline">
	...
	<div class="col-sm-12">
		<div class="pull-left">
			...
			<shiro:hasPermission name="teaching:tClassStudent:add">
			    <table:addRow url="${ctx}/teaching/tClassStudent/enterform?source=classstudentlist" title="报名【大班制】" label="新增报名【大班制】" width="900px"></table:addRow>
			</shiro:hasPermission>
			<!--  
			<shiro:hasPermission name="teaching:tClassStudent:add">
			...
			<tr>
				...
				<td>
					...
					<shiro:hasPermission name="teaching:tClassStudent:edit">
    					<a href="#" onclick="openDialog('修改报名', '${ctx}/teaching/tClassStudent/enterform?id=${tClassStudent.id}&ccid=${tClassStudent.courseclass.id}&source=classstudentlist','900px', '500px')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i> 修改</a>
    				</shiro:hasPermission>
					</c:if>
