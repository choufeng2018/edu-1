...
<body>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>补课方式：</label></td>
					<td class="width-35">
						<form:radiobuttons path="canmakeup" items="${fns:getDictList('makeup_type')}" itemLabel="label" itemValue="value" htmlEscape="false" class="i-checks required"/>
					</td>
