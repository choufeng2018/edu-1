...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="TClassStudent" action="${ctx}/teaching/tClassStudent/switchlist" method="post" class="form-inline">
		...
		<c:forEach items="${page.list}" var="tClassStudent">
			<tr>
				...
				<td>
					...
					<c:if test="${tClassStudent.status == '1' || tClassStudent.status == '4'}">
					<shiro:hasPermission name="teaching:tClassStudent:edit">
    					<a href="#" onclick="openDialogParent('转班', '${ctx}/teaching/tClassStudent/switchform?id=${tClassStudent.id}&type=1&source=${source}','900px', '650px')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i> 转班[1对1]</a>
    				</shiro:hasPermission>
    				<shiro:hasPermission name="teaching:tClassStudent:edit">
    					<a href="#" onclick="openDialogParent('转班', '${ctx}/teaching/tClassStudent/switchform?id=${tClassStudent.id}&type=2&source=${source}','900px', '650px')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i> 转班[大班制]</a>
    				</shiro:hasPermission>
    				</c:if>
				</td>
			</tr>
