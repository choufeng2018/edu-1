...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="TClassStudent" action="${ctx}/teaching/tClassStudent/minilist" method="post" class="form-inline">
		...
		<div class="form-group">
			...
			<span>专业：</span>
				...
				-->
				<sys:treeselect id="courseclass" name="courseclass.subject.id" value="${TClassStudent.courseclass.subject.id}" labelName="courseclass.subject.subjectName" labelValue="${TClassStudent.courseclass.subject.subjectName}"
	...
	<div class="col-sm-12">
		<div class="pull-left">
			...
			<shiro:hasPermission name="teaching:tClassStudent:add">
			    <table:addRow url="${ctx}/teaching/tClassStudent/enterformSmW?source=classstudent" title="新增报名【小班制】" width="900px" height="550px" label="新增报名【小班制】"></table:addRow>
			</shiro:hasPermission>
			<!--  
			<shiro:hasPermission name="teaching:tClassStudent:add">
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		...
		<c:forEach items="${page.list}" var="tClassStudent">
			<tr>
				...
				<td><a  href="#" onclick="openDialogView('查看报名详情', '${ctx}/teaching/tClassStudent/enterformSmW?id=${tClassStudent.id}','900px', '550px')">
				...
				<td>
					<shiro:hasPermission name="teaching:tClassStudent:view">
						<a href="#" onclick="openDialogView('查看报名', '${ctx}/teaching/tClassStudent/enterformSmW?id=${tClassStudent.id}','900px', '550px')" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 查看</a>
					</shiro:hasPermission>
					...
					<shiro:hasPermission name="teaching:tClassStudent:edit">
    					<a href="#" onclick="openDialog('修改报名', '${ctx}/teaching/tClassStudent/enterformSmW?id=${tClassStudent.id}&source=classstudent','900px', '550px')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i> 修改</a>
    				</shiro:hasPermission>
					</c:if>
