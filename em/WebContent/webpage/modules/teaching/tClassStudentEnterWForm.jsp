...
<body>
		<form:form id="inputForm" modelAttribute="tClassStudent" action="${ctx}/teaching/tClassStudent/entersaveW" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<!--<form:input path="courseclass.classDesc" htmlEscape="false" maxlength="11" class="form-control " readonly="true"/>-->
						<sys:gridselect url="${ctx}/subject/tCourseClass/selectlist" id="courseclass" name="courseclass.id"  value="${tClassStudent.courseclass.id}"  title="选择班级" labelName="courseclass.classDesc" 
							labelValue="${tClassStudent.courseclass.classDesc}" cssClass="form-control required" fieldLabels="" fieldKeys="" searchLabel="" searchKey="" callback="1"></sys:gridselect>
					</td>
				...
				<tr>
					...
					<td class="width-35" colspan="3"><div id="pri"></div></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>缴费总金额：</label></td>
					<td class="width-35">
