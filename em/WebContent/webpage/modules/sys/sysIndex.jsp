...
<head>
    ...
    <meta name="keywords" content="艺米科技">
    <meta name="description" content="艺米科技">
    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span>
                            <img alt="image" class="img-circle" style="height:64px;width:64px;" src="${(fns:getUser().photo==''||fns:getUser().photo==null)?'/em/userfiles/1/qrcode/12.png':fns:getUser().photo}" />
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li><a class="J_menuItem" href="${ctx}/sys/user/imageEdit">修改密码</a>
                                </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
                    ...
                    <div class="navbar-header"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                        <form role="search" class="navbar-form-custom" method="post" action="search_results.html">
                            <div class="form-group">
                                  <!-- <input type="text" value="${fns:getUser().company.name}" > 
                                                                             艺米艺术教学教务管理系统
                            	${UserUtils.getUser().getSchool().getSchoolName()}  
								<img alt="image" style="height:56px;width:288px;" src="/em/userfiles/1/qrcode/21.png" />    
								${fns:getUser().school.schoolName}          -->
                            </div>
                        </form>
                    </div>
            ...
            <div class="row content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        <a href="javascript:;" class="active J_menuTab" data-id="${ctx}/subject/tCourseTimetable/daychecklist">首页</a>
                    </div>
                </nav>
            ...
            <div class="row J_mainContent" id="content-main">
                ...
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${ctx}/echarts/pieClass" frameborder="0" data-id="${ctx}/echarts/pieClass" seamless></iframe>-->
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${ctx}/subject/tCourseTimetable/daychecklist" frameborder="0" data-id="${ctx}/subject/tCourseTimetable/daychecklist" seamless></iframe>
            </div>
            <div class="footer">
                <div class="pull-left"><a href="javascript:window.open('http://www.yimedu.org');">艺米艺术培训教务管理平台 V 0.1</a> &copy; 2016-2025</div>
            </div>
        </div>
        <!--右侧部分结束-->
