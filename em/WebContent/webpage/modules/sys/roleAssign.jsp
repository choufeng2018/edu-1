...
<body>
	...
	<div class="container-fluid breadcrumb">
		<div class="row-fluid span12">
			...
			<!-- <span class="span4">归属机构: <b>${role.office.name}</b></span> -->&nbsp;&nbsp;&nbsp;
			<span class="span4">英文名称: <b>${role.enname}</b></span>&nbsp;&nbsp;&nbsp;
	 
			<span class="span4">角色类型: <b>${role.roleType}</b></span>&nbsp;&nbsp;&nbsp;
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead><tr><th>姓名</th><th>学校（校区）</th><th>部门</th><th>登录名</th><th>手机</th><shiro:hasPermission name="sys:user:edit"><th>操作</th></shiro:hasPermission></tr></thead>
		<tbody>
