...
public class DateUtil {
	...
	private static final String DEFAULT_PATTERN1 = "yyyyMMdd";
	 ...
	 * @return
	 */
	public static String toString(long ldate){
		SimpleDateFormat sdf = new SimpleDateFormat(DEFAULT_PATTERN1);
		//前面的ldate是秒数，先乘1000得到毫秒数，再转为java.util.Date类型
		java.util.Date dt = new Date(ldate * 1000);  
