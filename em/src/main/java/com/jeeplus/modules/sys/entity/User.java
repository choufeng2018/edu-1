...
public class User extends DataEntity<User> {
	...
	@ExcelField(title="所属学校", align=2, sort=20, value="school.schoolName")
	...
	@Length(min=0, max=200, message="邮箱长度有误")
